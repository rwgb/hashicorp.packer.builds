// proxmox-clone source for Atomic Red Team Windows 10 build
source "proxmox-clone" "windows_10_atomic_red_team" {
  ...
  clone_vm_id          = 9020
  vm_id                = 9024
  vm_name              = "win-10-atomic-red-team"
  memory               = 8192
  cores                = 4
  sockets              = 1
  qemu_agent           = true
