// Packer build file for Debian 12 Base Template
// This is the foundation build that uses proxmox-iso to install from ISO
// All subsequent builds should clone from this template
...
locals {
  ...
  source_content = {
    "/ks.cfg" = templatefile("${abspath(path.root)}/data/ks.pkrtpl.hcl", {
      ...
      build_key           = data.sshkey.install.public_key
